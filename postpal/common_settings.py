...
SECRET_KEY = getattr(configs, 'SECRET_KEY', '9he6r2w*p-***13w&75f0(313hkqjwgumt(&5l$%d0cb1(g225')
    ...
    if not ENGINE or ENGINE == 'sqlite3':
        ...
        DATABASES = {
            'default': {
                ...
                'PORT': getattr(configs, 'DB_PORT', '3306'),
            }
        }
        ...
        DATABASES = {
            'default': {
                ...
                'PASSWORD': getattr(configs, 'DB_PASSWORD', 'password'),
                'HOST': getattr(configs, 'DB_HOST', '127.0.0.1'),
                'PORT': getattr(configs, 'DB_PORT', '5432'),
            }
        }
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                "postpal.context_processors.context_processor",
            ],
        },
    },
]
